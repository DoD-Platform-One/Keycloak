...
| dbchecker.image.repository | string | `"registry1.dso.mil/ironbank/opensource/postgres/postgresql-alpine"` |  |
| dbchecker.image.tag | string | `"15.10"` |  |
